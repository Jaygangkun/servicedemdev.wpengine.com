...
function primer_scripts_and_styles() {
  if (!is_admin()) {
	...
	// wow
	wp_register_script( 'wow-js', get_stylesheet_directory_uri() . '/library/js/libs/wow.min.js', array(), '', false );
	wp_register_style( 'wow-stylesheet', get_stylesheet_directory_uri() . '/library/css/animate.css', array(), '', 'all' );
	...
	//masonry
	wp_register_script( 'masonry-js', get_stylesheet_directory_uri() . '/library/js/libs/masonry.pkgd.min.js', array( 'jquery' ), '', true );
	
    //adding scripts file in the footer
    wp_register_script( 'primer-js', get_stylesheet_directory_uri() . '/library/js/scripts.js', array( 'jquery' ), '', true );

	// enqueue styles and scripts
	wp_enqueue_style('wow-stylesheet');
